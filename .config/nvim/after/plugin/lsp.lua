...
lsp_zero.on_attach(function(client, bufnr)
    ...
    vim.keymap.set("n", "[d", function() vim.diagnostic.goto_next() end, opts, { desc = 'Diagnostic goto next' })
    vim.keymap.set("n", "]d", function() vim.diagnostic.goto_prev() end, opts, { desc = 'Diagnostic goto prev' })
