...
__conda_setup="$('/home/ruben/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/ruben/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/ruben/anaconda3/etc/profile.d/conda.sh"
    else
